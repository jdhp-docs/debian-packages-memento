...
TODO_COPYRIGHT_NOTICE="Copyright (c) 2015,2016 ${TODO_AUTHOR_NAME} (${TODO_AUTHOR_WEB_SITE})"

TODO_DOCUMENT_DATE="22 septembre 2015"
TODO_INSTITUTE=""
TODO_DOCUMENT_SUBJECT="Commandes utiles pour l'administration des paquets Debian"
TODO_DOCUMENT_KEYWORDS="debian,paquet,commandes,apt,aptitude,dpkg,ubuntu,raspbian"

TODO_DOCUMENT_TITLE="Commandes utiles pour l'administration des paquets Debian"
TODO_DOCUMENT_SUBTITLE=""
TODO_DOCUMENT_FILE_BASE_NAME="commandes_paquets_debian"

TODO_DOCUMENT_GITHUB_ACCOUNT="jdhp-docs"
TODO_DOCUMENT_GITHUB_REPOSITORY_NAME="debian-packages-memento"
